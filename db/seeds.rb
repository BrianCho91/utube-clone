...
# ActiveRecord::Base.transaction do
  ...
  mary = User.create(username: "Mary", email: "mary@gmail.com", password: "123123")
    ...
    mary.photo.attach(io: pic3, filename: "pic3.jpg")
    banner3 = open("https://utube-seed.s3-us-west-1.amazonaws.com/user_pics/catdog.jpg")
    mary.banner.attach(io: banner3, filename: "banner3.jpg")
  ...
  video1 = Video.create(title: "I'm in your face", description: "Fast and Furious when Vin Diesel and Paul walker weren't friends", test_url: "", views: 13432, user_id: jason.id)
    ...
    pfile1 = open("https://utube-seed.s3-us-west-1.amazonaws.com/video_pics/face2.jpg")
